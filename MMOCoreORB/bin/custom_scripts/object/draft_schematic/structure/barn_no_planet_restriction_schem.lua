...
object_draft_schematic_structure_barn_no_planet_restriction_schem = object_draft_schematic_structure_shared_barn_no_planet_restriction_schem:new {
   ...
   targetTemplate = "object/tangible/deed/player_house_deed/barn_no_planet_restriction_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_structure_barn_no_planet_restriction_schem, "object/draft_schematic/structure/barn_no_planet_restriction_schem.iff")
