...
object_tangible_painting_painting_anniv = object_tangible_painting_shared_painting_anniv:new {
}
ObjectTemplates:addTemplate(object_tangible_painting_painting_anniv, "object/tangible/painting/painting_anniv.iff")
