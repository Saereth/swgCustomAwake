...
--SWG Awakening Custom - Commands
RunSlashCommandsFile("getKnightShrine.lua")
RunSlashCommandsFile("removePvpStates.lua")
RunSlashCommandsFile("resetKnightTrials.lua")
RunSlashCommandsFile("setKnightTrial.lua")
