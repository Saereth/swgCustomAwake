...
--SWG Awakening Custom -- Citizens Per Rank
CitizensPerRank = {10, 20, 30, 45, 60}
...
--SWG Awakening Custom -- Radius Per Rank
...
CityTaxes = {
	{--Income Tax
		min = 0, max = 10000, --SWG Awakening Custom -- Max City Tax
	...
	{--Property Tax
		min = 0, max = 200, --SWG Awakening Custom -- Max City Tax
	...
	{--Sales Tax
		min = 0, max = 50, --SWG Awakening Custom -- Max City Tax
	...
	{--Travel Tax
		min = 0, max = 1000, --SWG Awakening Custom -- Max City Tax
	...
	{--Garage Tax
		min = 0, max = 100, --SWG Awakening Custom -- Max City Tax
...
CitySpecializations = {
	...
	{--Entertainment District
		...
		cost = 80000,
		skillMods = {
			{"private_spec_entertainer", 20} --SWG Awakening Custom -- Increased Ent Skill Mod
		}
	},
	{--Stronghold
