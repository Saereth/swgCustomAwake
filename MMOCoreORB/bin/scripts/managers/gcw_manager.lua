...
sliceCooldown = 180 -- SWG Awakening Custom -- Slice Cooldown

dnaNucleotides = { "A", "G", "C", "T" }
dnaPairs = { "AT", "TA", "GC", "CG" }

totalDNASamples = 30 -- SWG Awakening Custom -- Total DNA Samples

dnaStrandLength = 23

-- Amount of time in seconds that a base destructino takes after the countdown is initiated
destructionTimer = 900  -- SWG Awakening Custom -- Destruction Timer

-- maximum bases per planet
maxBases = 50  -- SWG Awakening Custom -- Max Bases Per Planet
...
bonusXP = 25  -- SWG Awakening Custom -- Bonus Xp
...
winnerBonus = 25  -- SWG Awakening Custom -- Winner Bonus
loserBonus = -25  -- SWG Awakening Custom -- Loser Bonus

-- Spawn turrets and minefields when base is placed 1=true 0=false 
spawnDefenses = 0  -- SWG Awakening Custom -- Spawn Defences
