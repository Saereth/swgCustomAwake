...
shuttleportAwayTime = 160 --SWG Awakening Custom -- Shuttle Port Away Time
starportAwayTime = 300 --SWG Awakening Custom -- Star Port Away Time

--Time, in seconds, that a shuttle takes to land
shuttleportLandingTime = 10 --SWG Awakening Custom -- Shuttle Port Landing Time
starportLandingTime = 15 --SWG Awakening Custom -- Star Port Landing Time

--Time, in seconds, that a shuttle is landed for
shuttleportLandedTime = 120
starportLandedTime = 180 --SWG Awakening Custom -- Star Port Landed Time
...
corellia = {
	...
	planetObjects = {
		-----------------------------------------------
		--SWG Awakening Custom -- Enhancement Terminals
		-----------------------------------------------
		{templateFile = "enhancement_terminal.iff", ox = 0, oy = -0.666281, oz = 0, ow = 0.745701, x = -136.437, z = 28, y = -4730.23, parentid = 0} --Coronet
		-----------------------------------------------------
		--SWG Awakening Custom -- Character Builder Terminals
		-----------------------------------------------------
...
dantooine = {
	...
	planetObjects = {
		...
		--SWG Awakening Custom -- Enhancement Terminals
		-----------------------------------------------
		{templateFile = "enhancement_terminal.iff", ox = 0, oy = 0.695864, oz = 0, ow = 0.718174, x = 1585.68, z = 4, y = -6368.95, parentid = 0}, --Agro
		{templateFile = "enhancement_terminal.iff", ox = 0, oy = 0.725999, oz = 0, ow = -0.687696, x = -629.417, z = 3, y = 2481.24, parentid = 0} --Mining
		-----------------------------------------------------
		--SWG Awakening Custom -- Character Builder Terminals
		-----------------------------------------------------
...
lok = {
	...
	planetObjects = {
		...
		--SWG Awakening Custom -- Enhancement Terminals
		-----------------------------------------------
		{templateFile = "enhancement_terminal.iff", ox = 0, oy = 0.999879, oz = 0, ow = 0.015506, x = 464.677, z = 8.75806, y = 5506.49, parentid = 0} --Nym's
		-----------------------------------------------------
		--SWG Awakening Custom -- Character Builder Terminals
		-----------------------------------------------------
...
naboo = {
	...
	planetObjects = {
		...
		--SWG Awakening Custom -- Enhancement Terminals
		-----------------------------------------------
		{templateFile = "enhancement_terminal.iff", ox = 0, oy = 0.309582, oz = 0, ow = 0.950873, x = -4993.5, z = 6, y = 4174, parentid = 0} --Theed outside Med Center
		-----------------------------------------------------
		--SWG Awakening Custom -- Character Builder Terminals
		-----------------------------------------------------
...
rori = {
	...
	planetObjects = {
		...
		--SWG Awakening Custom -- Enhancement Terminals
		-----------------------------------------------
		{templateFile = "enhancement_terminal.iff", ox = 0, oy = -0.69192, oz = 0, ow = 0.721974, x = 5370.22, z = 80, y = 5666.04, parentid = 0} --Restuss
		-----------------------------------------------------
		--SWG Awakening Custom -- Character Builder Terminals
		-----------------------------------------------------
...
talus = {
	...
	planetObjects = {
		...
		--SWG Awakening Custom -- Enhancement Terminals
		-----------------------------------------------
		{templateFile = "enhancement_terminal.iff", ox = 0, oy = 0.692641, oz = 0, ow = 0.721282, x = 329.666, z = 6, y = -2924.69, parentid = 0} --Dearic
		-----------------------------------------------------
		--SWG Awakening Custom -- Character Builder Terminals
		-----------------------------------------------------
...
tatooine = {
	...
	planetObjects = {
		...
		--SWG Awakening Custom -- Enhancement Terminals
		-----------------------------------------------
		{templateFile = "enhancement_terminal.iff", ox = 0, oy = 0.768226, oz = 0, ow = -0.640178, x = 3533.04, z = 5, y = -4796, parentid = 0}, --Mos Eisley (Neutral Start)
		{templateFile = "enhancement_terminal.iff", ox = 0, oy = -0.486657, oz = 0, ow = 0.873593, x = -1271.07, z = 12, y = -3590.22, parentid = 0}, --Bestine (Imperial Start)
		{templateFile = "enhancement_terminal.iff", ox = 0, oy = -0.514176, oz = 0, ow = 0.857684, x = -2896.35, z = 5, y = 2130.87, parentid = 0} -- Mos Espa (Rebel Start)
		-----------------------------------------------------
		--SWG Awakening Custom -- Character Builder Terminals
		-----------------------------------------------------
