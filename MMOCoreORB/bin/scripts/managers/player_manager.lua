...
-----------------------------------
--SWG Awakening Custom -- GM buff values (/gmrevive buff)
...
--		{templateFile = "object/tangible/veteran_reward/antidecay.iff", milestone=360, oneTime=true, description="@veteran_new:antidecay"}, --SWG Awakening Custom -- ADK? Fuck No
