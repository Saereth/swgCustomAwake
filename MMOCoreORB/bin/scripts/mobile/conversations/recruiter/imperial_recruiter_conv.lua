...
--		{"@conversation/faction_recruiter_imperial:s_374", "leave_time_covert"}, -- I would like to use my personal leave time. (SWG Awakening Custom -- Disable Go On Leave)
...
--		{"@conversation/faction_recruiter_imperial:s_374", "leave_time_overt"}, -- I would like to use my personal leave time. (SWG Awakening Custom -- Disable Go On Leave)
