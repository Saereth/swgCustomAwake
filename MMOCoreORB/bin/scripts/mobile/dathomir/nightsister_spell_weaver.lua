nightsister_spell_weaver = Creature:new {
	...
	resists = {35,90,35,90,90,90,90,90,15}, --SWG Awakening Custom -- Resists
	meatType = "",
	meatAmount = 0,
	hideType = "",
	hideAmount = 0,
	...
	attacks = merge(tkamaster,fencermaster,pikemanmaster,brawlermaster,forcewielder) --SWG Awakening Custom -- Attacks
}
