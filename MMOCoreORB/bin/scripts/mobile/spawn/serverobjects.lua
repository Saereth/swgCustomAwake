...
--SWG Awakening Custom -- Lairs
includeFile("spawn/dwb_outside.lua")
includeFile("spawn/krayt_spawner.lua")
includeFile("spawn/corellia_corner.lua")
includeFile("spawn/dantooine_corner.lua")
includeFile("spawn/lok_corner.lua")
includeFile("spawn/naboo_corner.lua")
includeFile("spawn/rori_corner.lua")
includeFile("spawn/talus_corner.lua")
includeFile("spawn/tatooine_corner.lua")
