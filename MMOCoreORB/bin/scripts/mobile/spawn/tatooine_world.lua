tatooine_world = {
	...
	lairSpawns = {
		...
		},
		{
			...
			maxDifficulty = 15,
			numberToSpawn = 0,
			weighting = 6, --SWG Awakening Custom -- Modify Weighting
			size = 25
		},
		{
		...
		},
		{
			...
			spawnLimit = 5, --SWG Awakening Custom -- Spawn Limit
			minDifficulty = 122,
			maxDifficulty = 276,
			numberToSpawn = 0,
			weighting = 4,
		...
		},
		{
			...
			maxDifficulty = 276,
			numberToSpawn = 0,
			weighting = 5, --SWG Awakening Custom -- Weighting
			size = 35
		},
		{
			lairTemplateName = "tatooine_giant_canyon_krayt_dragon_pack_neutral_none",
			spawnLimit = 1, --SWG Awakening Custom -- Spawn Limit
			minDifficulty = 275,
			maxDifficulty = 400, --SWG Awakening Custom -- Max Difficulty
			numberToSpawn = 0,
			weighting = 2,
			size = 35
		},
		{
			...
			maxDifficulty = 304,
			numberToSpawn = 0,
			weighting = 4, --SWG Awakening Custom -- Weighting
			size = 35
		},
	}
}
