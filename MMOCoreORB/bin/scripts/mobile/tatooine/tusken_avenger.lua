tusken_avenger = Creature:new {
	...
	level = 48,
	chanceHit = 0.9, --SWG Awakening Custom -- Chance Hit
	damageMin = 700, --SWG Awakening Custom -- Damage Min
	damageMax = 1200, --SWG Awakening Custom -- Damage Max
	baseXp = 4734,
	baseHAM = 10000,
	baseHAMmax = 15000, --SWG Awakening Custom -- Base Ham Max
	armor = 0,
	--resists = {40,10,0,50,-1,30,-1,-1,-1},
	resists = {40,40,25,50,25,30,30,30,-1}, --SWG Awakening Custom -- Resists
	meatType = "",
	meatAmount = 0,
	hideType = "",
	hideAmount = 0,
