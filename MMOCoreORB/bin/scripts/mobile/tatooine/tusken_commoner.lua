tusken_commoner = Creature:new {
	...
	baseXp = 960,
	baseHAM = 3500, --SWG Awakening Custom -- Base Ham
	baseHAMmax = 5000, --SWG Awakening Custom -- Base Ham Max
	armor = 0,
	--resists = {5,5,5,5,5,5,5,5,-1},
	resists = {15,15,15,15,15,15,15,15,-1}, --SWG Awakening Custom -- Resists
	meatType = "",
	meatAmount = 0,
	hideType = "",
	hideAmount = 0,
