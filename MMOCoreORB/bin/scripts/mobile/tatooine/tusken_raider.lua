tusken_raider = Creature:new {
	...
	damageMin = 200, --SWG Awakening Custom -- Damage Min
	damageMax = 300, --SWG Awakening Custom -- Damage Max
	baseXp = 1609,
	baseHAM = 4500,
	baseHAMmax = 7500, --SWG Awakening Custom -- Base Ham Max
	armor = 0,
	--resists = {5,5,5,30,-1,30,-1,-1,-1},
	resists = {25,25,25,30,20,30,20,20,-1}, --SWG Awakening Custom -- Resists
	meatType = "",
	meatAmount = 0,
	hideType = "",
	hideAmount = 0,
