...
----------------------------------------------
shared_enhancement_terminal = SharedCreatureObjectTemplate:new {
clientTemplateFileName = "object/tangible/terminal/shared_terminal_jukebox.iff"
}
ObjectTemplates:addClientTemplate(shared_enhancement_terminal, "object/tangible/terminal/shared_terminal_jukebox.iff")
