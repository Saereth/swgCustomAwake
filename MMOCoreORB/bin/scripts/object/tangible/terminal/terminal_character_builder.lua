...
object_tangible_terminal_terminal_character_builder = object_tangible_terminal_shared_terminal_character_builder:new {
	...
	itemList = {
		"Character Options",
		{
			...
			"Max XP", "max_xp",
--			"Become Glowy", "become_glowy", --SWG Awakening Custom -- Disable Become Glowy
			"Faction Points",
			{
...
--				"@veteran_new:antidecay","object/tangible/veteran_reward/antidecay.iff", --SWG Awakening Custom -- Disable Anti Decay Kit
				--450 Day Rewards
