...
object_tangible_wearables_armor_mandalorian_armor_mandalorian_shoes = object_tangible_wearables_armor_mandalorian_shared_armor_mandalorian_shoes:new {
	...
	certificationsRequired = { "combat_bountyhunter_master"}, --SWG Awakening Custom -- Only Master Bounty Hunters Can Wear Mandalorian Armor
...
--	vulnerability = COLD + ELECTRICITY + STUN + LIGHTSABER,
	vulnerability = COLD + STUN, --SWG Awakening Custom -- Modified Vulnerabilities
	...
	--SWG Awakening Custom -- Modified Vulnerability Values
	kinetic = 75,
	energy = 75,
	electricity = 75,
	stun = 20,
