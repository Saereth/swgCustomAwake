...
object_weapon_melee_special_blacksun_razor = object_weapon_melee_special_shared_blacksun_razor:new {
	...
	idealRange = 1, --SWG Awakening Custom -- Ideal Range
	idealAccuracy = 2, --SWG Awakening Custom -- Ideal Accuracy
	
	maxRange = 7,
	maxRangeAccuracy = 3,

	minDamage = 90, --SWG Awakening Custom -- Min Damage
	maxDamage = 250, --SWG Awakening Custom -- Max Damage
	
	attackSpeed = 2.5, --SWG Awakening Custom -- Speed
