...
object_weapon_ranged_rifle_rifle_acid_beam = object_weapon_ranged_rifle_shared_rifle_acid_beam:new {
	...
	pointBlankRange = 0,
	pointBlankAccuracy = 5, --SWG Awakening Custom -- Point Blank Accuracy

	idealRange = 20, --SWG Awakening Custom -- Ideal Range
	idealAccuracy = 5, --SWG Awakening Custom -- Ideal Accuracy

	maxRange = 60, --SWG Awakening Custom -- Max Range
	maxRangeAccuracy = 5, --SWG Awakening Custom -- Max Range Accuracy

	minDamage = 150, --SWG Awakening Custom -- Min Damage
	maxDamage = 300, --SWG Awakening Custom -- Max Damage

	attackSpeed = 5.0, --SWG Awakening Custom -- Speed
