...
object_weapon_ranged_rifle_rifle_flame_thrower = object_weapon_ranged_rifle_shared_rifle_flame_thrower:new {
	...
	pointBlankAccuracy = 3, --SWG Awakening Custom -- Point Blank Accuracy
	pointBlankRange = 0,
	...
	maxRangeAccuracy = 3, --SWG Awakening Custom -- Max Range Accuracy

	minDamage = 480,
	maxDamage = 830,

	attackSpeed = 6, --SWG Awakening Custom -- Speed
