...
function GeonosianLabScreenPlay:spawnMobiles()
	...
	spawnMobile("yavin4", "acklay",7200,117.9,-34.4,-313.3,-136,1627823, true) --SWG Awakening Custom -- Acklay Spawn
	...
	--SWG Awakening Custom -- Custom Spawn
	spawnMobile("yavin4", "crazed_geonosian_guard",120,4.8,8,20,-8,1627781)
	spawnMobile("yavin4", "crazed_geonosian_guard",120,6.2,8,20,-8,1627781)
	spawnMobile("yavin4", "crazed_geonosian_guard",120,7.8,8,20,-8,1627781)
	spawnMobile("yavin4", "crazed_geonosian_guard",120,9.2,8,20,-8,1627781)
	...
	--SWG Awakening Custom -- Custom Spawn
	spawnMobile("yavin4", "crazed_geonosian_guard",240,2.2,9.1,-8.1,63,1627781)
	spawnMobile("yavin4", "crazed_geonosian_guard",240,1.6,9.5,-3.5,99,1627781)
	spawnMobile("yavin4", "crazed_geonosian_guard",240,27.6,10.3,-13.3,-8,1627782)
	spawnMobile("yavin4", "crazed_geonosian_guard",240,33.3,9.5,-8.1,-105,1627782)
	spawnMobile("yavin4", "crazed_geonosian_guard",240,35.7,10.3,-14.4,-70,1627782)
	spawnMobile("yavin4", "crazed_geonosian_guard",240,36.4,9.8,-8.2,-109,1627782)
	spawnMobile("yavin4", "crazed_geonosian_guard",240,-56.9,-18,-33.9,95,1627785)
	spawnMobile("yavin4", "crazed_geonosian_guard",240,-56.6,-18,-43.2,72,1627785)
	spawnMobile("yavin4", "crazed_geonosian_guard",240,-39.7,-18,-47.5,-75,1627785)
	spawnMobile("yavin4", "crazed_geonosian_guard",240,-67.7,-19,-41.2,-77,1627788)
	spawnMobile("yavin4", "crazed_geonosian_guard",240,-71.5,-18.9,-34.5,-161,1627788)
	spawnMobile("yavin4", "crazed_geonosian_guard",240,-84.9,-18.5,-42.3,85,1627788)
	spawnMobile("yavin4", "crazed_geonosian_guard",240,-37,-22,-151.4,180,1627803)
	spawnMobile("yavin4", "crazed_geonosian_guard",240,-27.8,-22.9,-158,-90,1627803)
	spawnMobile("yavin4", "crazed_geonosian_guard",240,-20.4,-22.6,-151.7,-135,1627803)
	...
	--SWG Awakening Custom -- Custom Spawn
	spawnMobile("yavin4", "crazed_geonosian_guard",300,48.0,-34.0,-334.4,0,1627823)
	spawnMobile("yavin4", "crazed_geonosian_guard",180,53.0,-34.0,-330,0,1627823)
	spawnMobile("yavin4", "crazed_geonosian_guard",180,57.0,-34.0,-300,0,1627823)
	spawnMobile("yavin4", "enhanced_kliknik",240,66,-34,-333.9,5,1627823)
	spawnMobile("yavin4", "enhanced_kliknik",240,67,-34,-325.9,5,1627823)
	spawnMobile("yavin4", "enhanced_kliknik",240,91.2,-33.9,-347.9,5,1627823)
	spawnMobile("yavin4", "enhanced_kliknik",240,98,-34.1,-334.4,-53,1627823)
	spawnMobile("yavin4", "enhanced_kliknik",240,120.2,-33.9,-330.6,-33,1627823)
	spawnMobile("yavin4", "enhanced_kliknik",240,85.0,-33.8,-309.1,143,1627823)
	spawnMobile("yavin4", "enhanced_kliknik",240,74.7,-34.1,-329.0,-90,1627823)
	spawnMobile("yavin4", "enhanced_kliknik",240,95,-34,-340,5,1627823)
	spawnMobile("yavin4", "enhanced_kliknik",240,101,-34,-328,-180,1627823)
	spawnMobile("yavin4", "enhanced_kliknik",240,110,-34,-330,-20,1627823)
	spawnMobile("yavin4", "enhanced_kliknik",240,90,-34,-310,110,1627823)
	spawnMobile("yavin4", "enhanced_kliknik",240,80,-34,-330,-70,1627823)
	spawnMobile("yavin4", "enhanced_kliknik",240,91,-34.5,-320,-155,1627823)
	spawnMobile("yavin4", "enhanced_kliknik",240,102,-34,-308,120,1627823)
	spawnMobile("yavin4", "enhanced_kliknik",240,119,-34,-309,-100,1627823)
