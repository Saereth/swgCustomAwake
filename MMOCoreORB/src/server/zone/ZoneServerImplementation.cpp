...
ZoneServerImplementation::ZoneServerImplementation(ConfigManager* config) :
	...
	//SWG Awakening Custom -- Knight Trials, Knight Trials Manager
	knightTrialsManager = NULL;
...
void ZoneServerImplementation::startManagers() {
	...
	//SWG Awakening Custom -- Knight Trials, Start Knight Trials Manager
	knightTrialsManager = new KnightTrialsManager(_this.getReferenceUnsafeStaticCast(), processor);
	knightTrialsManager->deploy("KnightTrialsManager");
...
void ZoneServerImplementation::loadLoginMessage() {
	...
	try {
		//SWG Awakening Custom -- Read MOTD From The Custom_Scripts Directory
