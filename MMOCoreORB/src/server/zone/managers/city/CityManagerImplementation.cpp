...
void CityManagerImplementation::processCityUpdate(CityRegion* city) {
	...
	try {
		...
		//SWG Awakening Custom -- City Alignment System, Set To Neutral Upon Rank Loss If Rank Is Not Met;
...
void CityManagerImplementation::contractCity(CityRegion* city) {
	...
	//SWG Awakening Custom -- City Dual Spec, Metropolis Check
...
void CityManagerImplementation::unregisterCitizen(CityRegion* city, CreatureObject* creature) {
	...
	if (mayor != NULL && mayor->isPlayerCreature()) {
		...
		//SWG Awakening Custom -- Send Mail To Mayor Is Citizenship Requirements Are Not Met For The Current Rank Upon Cizizen Loss.
		} else {
			StringIdChatParameter params("city/city", "A citizen has left your city. Your city no longer meets the required population for its current rank.");
			params.setTO(creature->getDisplayedName());
...
//SWG Awakening Custom -- City Alignment System, Set City Alignment
...
//SWG Awakening Custom -- City Alignment System, Remove City Alignment
