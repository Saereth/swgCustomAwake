...
void JediManager::loadConfiguration(Lua* luaEngine) {
	...
	//SWG Awakening Custom -- Jedi System, Custom Jedi Manager Read From Custom_Scripts Dir
	bool useCustomJediMananager = luaEngine->runFile("custom_scripts/managers/jedi/jedi_manager.lua");

	if (!useCustomJediMananager) {
		warning ("Using default SWGEmu Jedi System.");
