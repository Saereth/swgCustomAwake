...
public:
	...
	enum { // default visibility modifiers if value does not exist in LUA
		ROBEVISMOD = 20, // equipping robe cost
		SABERVISMOD = 20, // equipping saber cost
		COMBATVISMOD = 35, // Combat action or force power cost
		BUFFVISMOD = 20 // jedi self buff cost
	};
