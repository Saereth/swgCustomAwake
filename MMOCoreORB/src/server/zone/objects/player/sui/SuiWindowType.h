...
public:
	enum {
		...
		//Choose A Side
		JEDI_CHOOSE_FACTION                = 310,

		//Character Builder 311 - 319
		CHARACTER_BUILDER_LIST             = 311,

		//SWG Awakening Custom -- Enhancement Terminal, Sui Window Type
		E_TERMINAL_LIST             	   = 320,
		...
		LIGHT_FRS_PETITION                 = 1039,
		DARK_FRS_PETITION                  = 1040,
		SHUTTLE_BEACON		               = 1041,
		FIELD_FACTION_CHANGE	           = 1042,
		GOTO_LIST			   			   = 1043
	};
};
