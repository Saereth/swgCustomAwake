...
public:
	...
	//SWG Awakening Custom -- Knight Trials, Trial Creature Killed Observer Type
	const static int TRIALKILLEDCREATURE 		= 69; //ManagedObject arg1 = destructedObject, long arg2 = 0 used when a player kills a knight trial creature.
	const static int CREATUREREVIVED			= 70; // ManagedObject arg1 = healer (optional), long arg2 = 0
};
